...
# Files to fix
files_to_fix = {
    'hermass_state_ops.py': '''#!/usr/bin/env python3
...
# Fix all files
for filename, source in files_to_fix.items():
    ...
    print(f'Created: {target}, size={target.stat().st_size}')
    
    b = target.read_bytes()
    print(f'  null_count={b.count(0)}, first_bytes={b[:20]}')
    print()
