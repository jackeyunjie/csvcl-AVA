...
- generated_at: 2026-06-10 10:16:55
- action: check
- symbols: EURUSD
- status: failed
...
```json
{
  ...
  "symbols": {
    "EURUSD": {
      ...
      "M15": {
        "ok": false,
        "raw_latest": "2026-06-09 23:30:00",
  ...
  "symbols": {
    "EURUSD": {
      "d1_ma_144_169_200": {
        ...
        "close": 1.15406,
        "ma144": 1.1690033333333334,
        "ma169": 1.1689337278106509,
        "ma200": 1.16711085,
...
## Table Exports
- local csv: D:\qoder\csvcl - AVA\MT5_AI_Trading\reports\ops\tables\hermass_state_table_20260610_101655.csv (1 rows)
- local markdown: D:\qoder\csvcl - AVA\MT5_AI_Trading\reports\ops\tables\hermass_state_table_20260610_101655.md (1 rows)
...
```json
{
  ...
  "error": "Set --lark-spreadsheet-token or --lark-url, or HERMASS_LARK_SPREADSHEET_TOKEN/HERMASS_LARK_URL."
}
```

## Notes
- Table export failures: D:\Programs\Obsidian\locales\MT5AVATRADE\MT5avatrDE\Hermass\Tables: [WinError 5] 拒绝访问。: 'D:\\Programs\\Obsidian\\locales\\MT5AVATRADE\\MT5avatrDE\\Hermass\\Tables'
- Lark sync did not complete; local table/report output remains authoritative.
- Report export failures: D:\Programs\Obsidian\locales\MT5AVATRADE\MT5avatrDE\Hermass\Reports\hermass_state_ops_20260610_101655.md: [Errno 13] Permission denied: 'D:\\Programs\\Obsidian\\locales\\MT5AVATRADE\\MT5avatrDE\\Hermass\\Reports\\hermass_state_ops_20260610_101655.md'
