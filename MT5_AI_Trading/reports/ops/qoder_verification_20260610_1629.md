...
|---|---|---|---|
| Report MD | `reports/ops/hermass_state_ops_20260610_162816.md` | Yes | 387 bytes |
| Table CSV | `reports/ops/tables/hermass_state_table_20260610_162816.csv` | Yes | 882 bytes, 1 data row |
| Table MD | `reports/ops/tables/hermass_state_table_20260610_162816.md` | Yes | 1462 bytes |
| Obsidian CSV | `D:\Programs\Obsidian\...\Tables\hermass_state_table_20260610_162816.csv` | Yes | Auto-synced |
| Obsidian MD | `D:\Programs\Obsidian\...\Tables\hermass_state_table_20260610_162816.md` | Yes | Auto-synced |
| Obsidian Report | `D:\Programs\Obsidian\...\Reports\hermass_state_ops_20260610_162816.md` | Yes | Auto-synced |
...
- **Logs**: `logs/` directory exists (scheduler.log not present, other logs exist)
