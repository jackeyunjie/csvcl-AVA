...
//---- 输入参数
input string PivotRangeStart="02:30";   // 枢轴区间起始时间
...
int OnInit()
  {
   ...
   IndicatorSetString(INDICATOR_SHORTNAME,"ACD_3 ThreeDay Pivot");
...
void SetSmartTimes()
  {
   ...
   if(sym=="NZDUSD")                           {PivotRangeStart="00:00"; PivotRangeEnd="00:00";}
                                                ...
                                                {PivotRangeStart="02:20"; PivotRangeEnd="02:20";}
   else if(sym=="NIK225")                      {PivotRangeStart="01:31"; PivotRangeEnd="08:00";}
   else if(sym=="NKD"||sym=="NIKKEI.p")        {PivotRangeStart="01:31"; PivotRangeEnd="23:30";}
   ...
   else if(sym=="FDAX"||sym=="DAX.p")          {PivotRangeStart="09:30"; PivotRangeEnd="22:30";}
   ...
   else if(sym=="NQ100"||sym=="SPX500"||sym=="DJI30")
                                                {PivotRangeStart="00:15"; PivotRangeEnd="23:30";}
   else if(sym=="NQ"||sym=="ES"||sym=="YM")    {PivotRangeStart="01:15"; PivotRangeEnd="22:30";}
